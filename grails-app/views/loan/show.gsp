...
<div id="show-loanRequest" class="content scaffold-show" role="main">
    ...
    <g:form resource="${this.loanRequest}" method="DELETE">
        <fieldset class="buttons">
            <g:link class="edit" action="edit" resource="${this.loanRequest}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
