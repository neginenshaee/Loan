...
grails.plugin.springsecurity.controllerAnnotations.staticRules = [
	...
	[pattern: '/user/forgetpassword',    access: ['permitAll']],
	[pattern: '/user/sendresetpassword',    access: ['permitAll']],
	[pattern: '/user/resetpassword/**',    access: ['permitAll']],
	[pattern: '/user/reset',    access: ['permitAll']],
	[pattern: '/loan/calculator',access: ['permitAll']],
	[pattern: '/user/save',		 access: ['permitAll']],
	[pattern: '/user/confirm/**',access: ['permitAll']],
